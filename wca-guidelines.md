...
- 2c+) [附加] 第一次參賽的參賽者必須要使用自己的法律上正式名字，或是參賽者希望被稱呼的名字。姓氏必須是法律上登記的姓氏。
...
- 2s++) [舉例] 參賽者的特殊狀況（例如：宗教信仰）讓他們無法在某一日或某個時間比賽，可以在不同的時間參賽，由WCA代表決定。WCA代表在對應這種特殊請求時，應該要考量到執行比賽流程所需要的資源。包含先讓該參賽者在前幾輪未結束前暫時比下幾輪的可能性。
